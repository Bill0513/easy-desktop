  ...
  <div class="h-full flex flex-col">
    ...
    <div class="mt-2 flex justify-center">
      ...
      >
        <template #trigger>
          <button
            class="px-3 py-1.5 text-sm font-handwritten rounded border-2 border-border-primary hover:bg-muted/50 transition-colors flex items-center gap-1 text-text-primary"
          >
