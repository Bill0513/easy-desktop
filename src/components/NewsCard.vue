          ...
          <div class="flex items-start gap-2">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center gap-2 mt-1">
                <span class="font-handwritten text-xs text-pencil/50">{{ item.time }}</span>
                <span class="text-xs text-pencil/30">•</span>
                <span class="font-handwritten text-xs text-pencil/50">{{ source.name }}</span>
              </div>
            </div>
