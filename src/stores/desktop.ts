...
import type { Widget, WidgetType, NoteWidget, TodoWidget, BookmarkWidget, FolderWidget, TextWidget, CreateWidgetParams, TodoItem, Bookmark, DesktopData } from '@/types'
